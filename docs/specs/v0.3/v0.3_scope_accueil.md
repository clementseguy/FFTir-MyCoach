...
|----|---------|--------------------|-----|------|
| F01 | Onglets Synthèse/Avancé | Deux onglets, Synthèse par défaut | A | à faire |
...
| F08 | Card Rolling 30j vs 60j | Afficher avg30 / avg60 / delta | B | à faire |
...
| F12 | Suppression "Mes dernières sessions" | Retirer section obsolète | C | à faire |
| F13 | Filtrage sessions réalisées uniquement | Exclure statut 'prévue' dans TOUS calculs | C | à faire |
| F14 | Ordre chronologique séries strict | Vérifier tri + tests (date + ordre interne) | C | à faire |
| F15 | Documentation stats v0.3 | Doc technique complète (statistiques.md) | C | fait |
| F16 | Centraliser tests filtrage/stat windows | Ajout tests unitaires pour filtres 30/60j et statut | C | à faire |
| F17 | Titres centrés | Tous les titres de graphs/tableaux centrés | D | à faire |
| F18 | Légendes sous composants | Harmoniser position légendes | D | partiel |
| F19 | Renommer page Accueil | Nouveau nom plus explicite | D | à faire |
...
| F24 | Filtre unique statut (Rolling + StatsService) | Refactor central de filtrage statut | C | à faire |
